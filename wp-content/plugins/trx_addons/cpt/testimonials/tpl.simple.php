...
if ($query->found_posts > 0) {
	...
	?><div class="sc_testimonials sc_testimonials_simple<?php if ($args['slider']) echo ' swiper-slider-container slider_swiper slider_nocontrols '.($args['slider_pagination'] > 0 ? 'slider_pagination' : 'slider_nopagination'); ?>"<?php
